...
{
	if(inS > inE) //bcs start is 0 and length =0 thus end is 0-1 = -1 thus this condtn for empty tree
		return NULL; // if true for this and this condtn returns null, pre valo me bhi same hi hoga
